...
| v0.30 | 2026-09-03 | 完成 I-010 仓库侧收口：Fastify 自定义 UUID trace id、`x-request-id` 响应头、结构化 `onResponse` 日志、稳定错误码日志、脱敏哈希（IP/用户/家庭/邮箱）与 journald 检索脚本；关闭 Fastify 原始请求日志避免裸 IP/查询串；新增 3 项隐私/日志断言，API 44/44、migration 241 statements、OpenAPI 68 paths/91 schemas、web build 全部通过 | I-010 更新为 `PARTIAL / REPO_READY`；真实 staging 重启、journald 检索和错误码检索仍待 live 验收 |
