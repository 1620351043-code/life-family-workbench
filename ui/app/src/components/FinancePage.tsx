...
export function FinancePage() {
  ...
  return (
    <section className="finance-page">
      ...
      {importOpen && <FinanceImportWizard accounts={accounts} onClose={() => setImportOpen(false)} onError={setError} onOpenImportedTransactions={(batchId) => { setImportOpen(false); setFinanceDataVersion((value) => value + 1); void refreshFinance("period"); openTransactions(batchId); }} onChanged={() => { setFinanceDataVersion((value) => value + 1); void refreshFinance("period"); }} />}
